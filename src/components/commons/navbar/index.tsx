...
const Navbar = () => {
  ...
  return (
    ...
    <nav className="pl-[var(--pading-section)]  pr-[var(--pading-section)] h-[var(--nav-bot-height)] w-full flex flex-row justify-between items-center fixed bottom-0 left-0 bg-white border-2 border-black-900 md:h-[calc(100vh-var(--header-height))] md:w-[6.8rem] md:flex-col md:justify-start md:gap-8 md:pt-8 lg:w-[25rem] lg:pl-[var(--pading-section)] lg:items-start">
      {navLinks
